function values = forecastingTimeseries( targetResources,returnedMetric,targetMetric,method,parameters, obj, mode, dcAgent )

N = size(targetResources,2);

flag = 0;
for i = 1:N
    temp_str = obj.obtainData(targetResources{1,i},targetMetric);
    ...
    returnedMetric
    try 
        dcAgent.sendSyncMonitoringDatum(num2str(values),returnedMetric,targetResources{1,i});
    catch err
